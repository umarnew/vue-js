<template>
<div class="counter">
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam, laboriosam fugiat. Eaque veniam, non atque temporibus recusandae voluptas expedita dolorum, laborum sed blanditiis numquam rem eligendi cumque, reiciendis suscipit eveniet.</p>
    <svg class="counter1" :viewBox="`0 0 ${UNITS} ${UNITS}`" :height="size || '10%'" :width="size || '10%'">
